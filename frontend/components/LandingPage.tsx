        ...
        <div className="relative max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="flex flex-col items-start gap-3 mb-4">
              ...
              <div className="text-sm text-gray-600">Geen account · Geen creditcard · 14 dagen gratis</div>

              {/* Secondary navigation: direct deep links (subtle) */}
              <div className="h-px w-full bg-gray-200 my-3" aria-hidden></div>
              <div className="text-[15px] text-gray-700 font-medium">
                <span className="mr-2">Of spring direct naar:</span>
                <a href="/groepsplan/new" className="underline-offset-4 hover:underline" onClick={() => track('cta_click', { cta: 'direct_groepsplan', device })}>Groepsplan</a>
                <span className="mx-2">·</span>
                <a href="/opp/new" className="underline-offset-4 hover:underline" onClick={() => track('cta_click', { cta: 'direct_opp', device })}>OPP</a>
                <span className="mx-2">·</span>
                <a href="/maatwerk/new" className="underline-offset-4 hover:underline" onClick={() => track('cta_click', { cta: 'direct_differentiatie', device })}>Differentiatie</a>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            {demoUrl ? (
              ...
              <div className="bg-white rounded-xl shadow-2xl p-6 border border-gray-200">
                ...
                <div className="text-center text-sm text-gray-500 mt-3">Klaar in 3–5 minuten</div>
              </div>
            )}
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div id="empathy" className="bg-gradient-to-br from-amber-100 to-amber-50 rounded-xl p-6 md:p-10 shadow-sm">
            ...
            <div className="space-y-3 md:space-y-4 mb-8">
              {[
                { text: "Je kopieert je vorige groepsplan en past de datums aan. Voelt alsof vals spelen, maar je hebt geen tijd.", icon: "🎯" },
                ...
                { text: "Je googelt 'groepsplan voorbeelden'. De templates zijn te algemeen of verouderd.", icon: "🔍" },
              ].map((item, idx) => (
                <div
                  key={idx}
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Vanaf €9,99/mnd (individueel) · Schoollicenties beschikbaar</p>
          </div>
            ...
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
                ...
                <div className="flex items-center gap-3">
                  <div className={`${t.bg} ${t.color} w-10 h-10 rounded-full flex items-center justify-center font-semibold`}>{t.init}</div>
                  <div>
